...
function dezSettings({typography, version, layout, navheaderBg, headerBg, sidebarStyle, sidebarBg, sidebarText, sidebarPosition, headerPosition, containerLayout, direction, primary}) {
    ...
    this.sidebarText = sidebarText || "color_1";
...
dezSettings.prototype.manageSidebarText = function() {
    switch(this.sidebarText) {
        case "color_1":
